...
public class DataStore {
	...
	private static void loadUsers() {
		...
		users[2] = UserService.getInstance().createUser(1002, "user2@crypto.com", "test", "Himanshu", "Jatale",
				Gender.MALE, UserType.EDITOR);
		users[3] = UserService.getInstance().createUser(1003, "user3@crypto.com", "test", "Prachi", "Desai",
